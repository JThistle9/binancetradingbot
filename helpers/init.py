...
def parse_args():
	...
	parser.add_argument('-c', '--config', type=json.loads, default='{\"sellPercent\":\"0.02\", \"buyPercent\":\"0.02\"}',
		help="dictionary of configurations for the specified strategy. Default: to {\"sellPercent\":\"0.02\", \"buyPercent\":\"0.02\"}")
	...
	parser.add_argument('-tp', '--take-profit', type=float, default=0.01,
		help="The take profit percent that must have been made before a crypto will be sellable. Default: 0.01")
	args = parser.parse_args()
	return get_strategy(args.strategy, args.config, args.historical_interval, args.historical_window), args.take_profit
