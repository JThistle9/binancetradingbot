...
CREDS = Credentials.from_authorized_user_file(os.path.join(creds_path, 'spreadsheet_token.json'), ['https://www.googleapis.com/auth/spreadsheets'])
# ids for specific spreadsheet
spreadsheet_structure = json.load(open(os.path.join(creds_path, 'spreadsheet_structure.json')))

SPREADSHEET_ID = spreadsheet_structure["SPREADSHEET_ID"]
BOUGHT_RANGE = spreadsheet_structure["BOUGHT_RANGE"]
SOLD_RANGE = spreadsheet_structure["SOLD_RANGE"]
